...
export const WEDDING_DATE = dayjs.tz("2026-09-19 13:20", "Asia/Seoul")
...
export const WEDDING_HALL_POSITION = [127.069633616599, 37.539121717454]
...
export const KMAP_PLACE_ID = 67986660

export const BRIDE_FULLNAME = "이채은"
export const BRIDE_FIRSTNAME = "채은"
export const BRIDE_TITLE = "장녀"
export const BRIDE_FATHER = "이용신"
export const BRIDE_MOTHER = "정미선"
...
export const GROOM_FULLNAME = "이욱"
export const GROOM_FIRSTNAME = "욱"
export const GROOM_TITLE = "장남"
export const GROOM_FATHER = "이영근"
export const GROOM_MOTHER = "임희정"
export const GROOM_INFO = [
  {
    relation: "신랑",
    name: GROOM_FULLNAME,
    phone: "010-0000-0000",
    account: "카카오뱅크 00000000000000",
  },
  {
    relation: "신랑 아버지",
    name: GROOM_FATHER,
