...
export const Invitation = () => {
  ...
  return (
    <LazyDiv className="card invitation">
      ...
      <div className="content">선선한 가을 바람이 불어오는 날</div>
      <div className="content">소중한 분들을 모시고</div>
      <div className="content">사랑의 약속을 하려고 합니다.</div>
      <div className="break" />
      <div className="content">서로에게 다정한 온기가 되어주고,</div>
      <div className="content">바람 부는 날엔 곁을 지켜주는</div>
      <div className="content">평생의 동반자가 되겠습니다.</div>
      <div className="break" />
